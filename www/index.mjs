...
const dyld = await main({
    ...
    searchDirs: [
        "/tmp/clib",
        "/tmp/hslib/lib/wasm32-wasi-ghc-9.14.1.20260330-4b5d",
        // "/tmp/hslib/lib/wasm32-wasi-ghc-9.14.0.20251031-inplace",
    ],
    mainSoPath: "/tmp/libHShint-in-browser-0.1.0.0-inplace-ghc9.14.1.20260330.so",
    args: ["libHShint-in-browser-0.1.0.0-inplace-ghc9.14.1.20260330.so", "+RTS", "-c", "-RTS"],
